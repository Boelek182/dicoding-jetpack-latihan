...
class BookmarkAdapter(private val activity: Activity?, private val callback: BookmarkFragmentCallback, private val mCourses: MutableList<CourseEntity>) : RecyclerView.Adapter<BookmarkAdapter.BookmarViewHolder>() {
