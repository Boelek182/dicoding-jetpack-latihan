...
class DetailCourseActivityTest {
    ...
    @Rule
    @JvmField
    var activityRule: ActivityTestRule<DetailCourseActivity> = object : ActivityTestRule<DetailCourseActivity>(DetailCourseActivity::class.java) {
    ...
    fun loadCourse() {
        ...
        onView(withId(R.id.textDate)).check(matches(withText(String.format("Deadline %s", dummyCourse.deadline))))
    }
